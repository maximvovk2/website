...
/**
 * This is the model class for table "projects_pics".
 *
 * The followings are the available columns in table 'projects_pics':
 * @property integer $id
 ...
 */
class ProjectsPics extends CActiveRecord
{
	/**
	 ...
	 * @return ProjectsPics the static model class
	 */
